...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, @ColorInt int mShowStartColor, @ColorInt int
            mShowEndColor, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = mShowStartColor;
        this.mShadowEndColor = mShowEndColor;
